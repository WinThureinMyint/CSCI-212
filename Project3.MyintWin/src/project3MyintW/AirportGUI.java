...
public class AirportGUI extends JFrame implements ActionListener {
	...
	private JTextField[] textbox = { new JTextField("3000"), new JTextField("3000"), new JTextField("5000"),
			new JTextField("5000") };
	...
	public AirportGUI() {
		...
		String[] s = { "Acme International Airport", "Airline Arrival/Departure Simulation", "Arrivals", "Departures",
				"Processed" };
	...
	public synchronized long elaspedTime() {
		return Simulation.timeInMinutes(Calendar.getInstance().getTimeInMillis()) - simStartTime;
	}
}
